...
namespace Articy.The_Road_To_Moscow.Features
{
    ...
    public class EntityFFeatureConstraint
    {
        
        private Boolean mLoadedConstraints;
        
        private EnumConstraint mTextPosdition;
        
        public EnumConstraint TextPosdition
        {
            get
            {
                EnsureConstraints();
        ...
        public virtual void EnsureConstraints()
        {
            ...
            mTextPosdition = new Articy.Unity.Constraints.EnumConstraint(false, "BySortIndex");
        }
    }
}
